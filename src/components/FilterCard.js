...
class FilterCard extends React.Component {
    ...
    render() {
        let optionSelectDOM = this.props.showGraphData.map((graphData, index) => {
            return (
                <option 
                        ...
                        <div>
                            ...
                            <div className="d-flex filter-card-date mt-2">
                                <div className="filter-card-date-div">
                                    ...
                                    <input className="form-control start-date" type="date" onChange={(e) => this.start_dateValidator(e.target.value)} />
                                </div>
                                <div className="filter-card-date-div">
                                    <label className="mb-0">End Date:</label>
                                    <input className="form-control end-date" type="date" onChange={(e) => this.end_dateValidator(e.target.value)} />
                                </div>
                            </div>
